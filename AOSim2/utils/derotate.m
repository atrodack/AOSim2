function PSF_ = derotate(PSF,CENTER,SED,ExpStart,ExpDur,DEC,LAT)

% PSF_ = derotate(PSF,CENTER,SED,ExpStart,ExpDur,DEC,LAT)
% 
% PSF: Image of the PSF 
% CENTER: Pixel location of the center of the PSF. (Can be non-integer)
% SED; List of brightness versus wavelength re PSF wavelength
